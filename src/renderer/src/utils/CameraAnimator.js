...
class CameraAnimator {
  ...
  static movePoints1 = [
    ...
    { x: -2.093, y: 8.291 - 2, z: 2.110 }, // 注視点 point1 屋根
    { x: 0, y: 5, z: 0 }, // 注視点中間用
  ...
  */
  ...
  // カメラ位置
  static rotatePoints = [
    { x: 0, y: 6, z: 12 }, // カメラ位置(回転時のオフセット)
    { x: 0, y: 3, z: 0 }, // 回転注視点
  ]

  static movePoints1 = [
    // x座標=-0.22706193766380045
    // y座標=5.169938428220243
  ...
  static movePoints2 = [
    // x座標=-5.715318092696046
    // y座標=5.8381218930471785
